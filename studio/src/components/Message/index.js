...
const Message = React.forwardRef(({document}, ref) => {
  ...
  if (isNew) {
    ...
    messageText = {
      ...
      message: (
        <>
          This is the <code>{variant}</code> Document, currently <strong>Draft</strong> and{' '}
          <strong>Live</strong>. Unless <strong>Unpublished</strong> it can be Referenced. When
          Published these changes will immediately be visible outside of the Studio.
        </>
      ),
    }
